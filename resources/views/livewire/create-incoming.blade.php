...
>
    ...
    >
        ...
        <div class="flex items-center justify-between border-b border-gray-100 px-6 py-4">
            <h5 class="text-lg font-semibold text-gray-900" id="createRecordModalLabel">Receive Transaction</h5>
            <button type="button" @click="open = false" class="rounded-lg p-1 text-gray-400 transition-colors duration-150 hover:bg-gray-100 hover:text-gray-600" aria-label="Close">
        ...
        @if (session()->has('message'))
            <div x-data x-init="setTimeout(() => $el.remove(), 4000)" class="mx-6 mt-4 flex items-center justify-between rounded-lg border border-green-200 bg-green-50 px-4 py-3 text-green-800 shadow-sm">
                <span class="text-sm font-medium">
                    {{ session('message') }}
                </span>
                <button type="button" onclick="this.parentElement.remove()" class="ml-4 text-green-600 hover:text-green-800 focus:outline-none">
        ...
        <div class="space-y-4 px-6 py-4">
            ...
            <!-- Office -->
            <div>
                <label for="office" class="block text-sm font-medium text-gray-700 mb-1">Origin Office</label>
            ...
            <div>
                ...
                <textarea wire:model="subject" rows="3"
                    class="w-full resize-none rounded-lg border-gray-300 px-4 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
        ...
        <div class="flex items-center justify-end gap-3 border-t border-gray-100 px-6 py-4">
            <button type="button" @click="open = false"
                class="rounded-lg px-4 py-2 text-sm font-medium text-gray-600 transition-colors duration-150 hover:bg-gray-100">
                Close
            </button>
            <button type="button"
