        ...
        <div class="space-y-4">
            ...
            @elseif (! $tokenRequired || $unlocked)
                ...
                <form wire:submit="sign" class="space-y-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:!bg-gray-800 p-4 shadow-sm">
                    ...
                    <div>
                        <label for="esignPassword" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">Password</label>
                        <input id="esignPassword" type="password" wire:model="password" autocomplete="current-password" class="{{ $input }}">
