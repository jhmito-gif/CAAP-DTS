<div class="contents">
    ...
    @if ($showModal)
        ...
        >
            ...
            {{-- Panel --}}
            <div class="relative flex max-h-[85vh] w-full max-w-lg flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
                ...
                <div class="min-h-0 flex-1 overflow-y-auto px-6 py-5">
                    ...
                    <select
                        ...
                        class="w-full rounded-lg border border-gray-300 py-2 pl-3 pr-8 text-sm text-gray-700 shadow-sm focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500"
                    >
                    ...
                    <div class="mt-5">
                        ...
                        <div class="mb-2 flex items-center justify-between">
                            ...
                            @if (count($selected) > 0)
                                <span class="rounded-full bg-violet-50 px-2 py-0.5 text-[11px] font-semibold text-violet-700">
                        ...
                        @else
                            ...
                            <div class="divide-y divide-gray-100 overflow-hidden rounded-lg border border-gray-200">
                                ...
                                @foreach ($personnel as $person)
                                    ...
                                    <label class="flex cursor-pointer items-center gap-3 px-3 py-2.5 transition hover:bg-violet-50/60">
                                        ...
                                        <input
                                            ...
                                            class="size-4 shrink-0 rounded border-gray-300 text-violet-600 focus:ring-violet-500"
                                        >

                                        <div class="flex size-8 shrink-0 items-center justify-center rounded-full bg-gray-100 text-xs font-bold uppercase text-gray-500">
                            ...
                            <div class="flex flex-wrap gap-1.5">
                                ...
                                @foreach ($taggedUsers as $tagged)
                                    <span class="inline-flex items-center gap-1.5 rounded-full border border-violet-200 bg-violet-50 px-2.5 py-1 text-xs font-semibold text-violet-700">
                                        {{ $tagged->name }}
                                        <span class="text-violet-400">{{ $tagged->pivot->office ?: $tagged->office }}</span>
                                    </span>
                                @endforeach
                ...
                <div class="flex items-center justify-end gap-2 border-t border-gray-100 bg-gray-50 px-6 py-4">
                    ...
                    <button
                        type="button"
                        wire:click="closeModal"
                        class="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 shadow-sm transition hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
                    >
                        Cancel
                    </button>
