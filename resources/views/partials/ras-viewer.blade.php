...
<section class="overflow-hidden rounded-lg border border-gray-300 bg-white" aria-labelledby="ras-viewer-title">
    <div class="flex items-center justify-between gap-3 border-b border-gray-200 px-4 py-3">
        <div class="flex min-w-0 items-center gap-3">
            ...
            <div class="min-w-0">
                <h2 id="ras-viewer-title" class="truncate text-sm font-bold text-gray-900">RAS Viewer</h2>
        ...
        <a
            ...
            class="inline-flex shrink-0 items-center gap-2 rounded-md border border-gray-300 bg-white px-3 py-2 text-xs font-semibold text-gray-700 transition hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        >
    ...
    <div class="{{ $heightClass ?? 'h-[720px]' }} bg-gray-200 p-2">
        <iframe
